...
param goodWeDataForwardingQueueName string
param goodWeDataForwardingQueueListenConnectionStringKeyName string
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        }
        {
          ...
          value: '@Microsoft.KeyVault(SecretUri=https://${keyVaultName}.vault.azure.net/secrets/${goodWeDataForwardingQueueListenConnectionStringKeyName}/)'
        }
        {
          name: 'GOODWE_DATAFORWARD_QUEUE_NAME'
          value: goodWeDataForwardingQueueName
        }
      ]
      connectionStrings: [
      ]
